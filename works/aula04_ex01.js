...
cylinderGeometry3.rotateX(1.5708);
cylinderGeometry3.translate(0,0.5,0);
var cylinderMaterial3 = new THREE.MeshPhongMaterial( {color:'rgb(255,255,000)'} );
...
cylinderGeometry4.rotateX(1.5708);
cylinderGeometry4.translate(0,-0.5,0);
var cylinderMaterial4 = new THREE.MeshPhongMaterial( {color:'rgb(255,255,000)'} );
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    if (animationRedCyl) cylinder2.matrix.multiply(mat4.makeRotationY(angle2)); // R1
    ...
    // Will execute R2, T1 and R1 in this order
    cylinder3.matrix.multiply(mat4.makeRotationY(angle4)); // R1
...
function buildInterface()
{
  ...
  gui.add(controls, 'onChangeAnimationRed',true).name("Red Cylinder On/Off");
